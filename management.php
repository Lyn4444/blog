...
include("config.php");
$sql = "select * from users where admin = 0 order by id DESC";
...
<div id="container">
    ...
    <div id="other-comments" class="other-comments">
        ...
        while ($row = mysqli_fetch_array($result1)) {
            ?>
            <h6 class="comments">用户名：<?php echo $row[0]; ?></h6>

            <h6 class="comments-right"><a href="postDelete.php">删除用户<?php setcookie('delete', strval($row[0]));?></a></h6>
